  ...
  return (
    <nav className="bg-black text-white p-2 flex items-center z-50 justify-between">
      ...
      <div className='lg:hidden'>
        ...
        <div className="text-lg font-semibold">Dynamics 365</div>
        <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
          <path fillRule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clipRule="evenodd" />
        </svg>
        <div className='hidden lg:block'>
        <div className="text-lg font-semibold">Finance and Operations</div>
        </div>
      </div>
      <div className='hidden lg:block'>
      <div className="flex items-center space-x-2 text-sm mr-4">
        <div className="flex items-center space-x-1">
          ...
          <span className='mr-4'>All vendors</span>
        </div>
        <div className="flex items-center space-x-5">
          <span className='mx-4'>USMF</span>
