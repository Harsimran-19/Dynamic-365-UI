...
const Sidebar: React.FC = () => {
  ...
  <aside className={`bg-white w-64 h-[calc(100vh-4rem)] overflow-y-auto p-2 transition-all duration-300 ${sidebarOpen ? 'fixed left-0 z-40' : 'hidden'} lg:static lg:block border-r border-gray-200`}>
      <nav className='text-black'>
        <div className="mb-4 ">
          <h2 className="text-xs font-semibold text-gray-500 uppercase mb-2 px-4">Favorites</h2>
          <ul>
            <li className="mb-1">
              <Link href="/vendors/all-purchase-orders" className="flex items-center text-sm text-blue-600 p-2 hover:bg-gray-100">
            ...
            <li className="mb-1">
              <Link href="/vendors/all-vendors" className="flex items-center text-sm text-blue-600 p-2 hover:bg-gray-100">
                <svg className="w-4 h-4 mr-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                  <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                </svg>
                All vendors
